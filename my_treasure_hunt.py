...
if q1 == 'left':
  ...
  q4 = input('You\'ve found a Dragon sleeping. Type "run" to run away from the room or "stay quiet" to leave quietly the room. ')
  if q4 == "run":
    print("The Dragon awakes and toasts you. Game Over.")
  else:
    print("You escape through a small door and found the treasure! You Win!")
else:
